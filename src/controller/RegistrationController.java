    ...
    private void btnRegistration(ActionEvent event) {
        ...
        if (isValidCondition()) {
            ...
            try {
                ...
                md.update(pfUserPassword.getText().getBytes());
