...
public class ViewSellController implements Initializable {
    ...
    public void viewDetails() {
        ...
        tblClmPursrsPrice.setCellValueFactory(new PropertyValueFactory<>("purchasePrice"));
        ...
        sellCartGateway.firstTenView(sellCart);
    }
    ...
    private void tfSearchOnKeyReleased(KeyEvent event) {
        ...
        sellCartGateway.searchView(sellCart);
