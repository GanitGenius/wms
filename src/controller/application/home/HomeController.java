...
public class HomeController implements Initializable {
    ...
    public void valueCount() {
        ...
        try {
            pst = con.prepareStatement("select sum(PurchasePrice) from " + db + ".Products");
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public void totalCount() {
        ...
        try {
            ...
            pst = con.prepareStatement("select count(*) from " + db + ".Supplier");
            rs = pst.executeQuery();
            while (rs.next()) {
            ...
            while (rs.next()) {
                ...
                txtOrgAddress.setText(rs.getString(8));
