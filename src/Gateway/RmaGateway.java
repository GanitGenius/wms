...
public class RmaGateway {
    ...
    public void save(RMA rma) {
        ...
        try {
            ...
            alert.setContentText("RMA" + "  '" + rma.rmaName + "' " + "Added successfully");
    ...
    public void update(RMA rma) {
        ...
        try {
            ...
            alert.setContentText("RMA" + "  '" + rma.rmaName + "' " + "Updated successfully");
            alert.initStyle(StageStyle.UNDECORATED);
            alert.showAndWait();
    ...
    public boolean isNotUse(RMA rma) {
        ...
        try {
            ...
            Logger.getLogger(RmaGateway.class.getName()).log(Level.SEVERE, null, ex);
        }
        return isNotUse;
