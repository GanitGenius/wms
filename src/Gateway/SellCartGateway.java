...
public class SellCartGateway {
    ...
    public void save(SellCart sellCart) {
        ...
        try {
            ...
            pst.setString(5, sellCart.purchasePrice);
            ...
            Logger.getLogger(SellCartGateway.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void view(SellCart sellCart) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                sellCart.purchasePrice = rs.getString(5);
                ...
                sellCart.soldList.addAll(new ListSold(sellCart.Id, sellCart.sellID, sellCart.productID, sellCart.givenProductID, sellCart.customerID, sellCart.customerName, sellCart.purchasePrice, sellCart.sellPrice, null, sellCart.quantity, sellCart.totalPrice, sellCart.pursrsDate, sellCart.warrentyVoidDate, sellCart.sellerID, sellCart.sellerName, sellCart.sellDate));
            }
            pst.close();
            con.close();
            rs.close();
